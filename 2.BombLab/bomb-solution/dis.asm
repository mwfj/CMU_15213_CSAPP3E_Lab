...
0000000000400da0 <main>:
  ...
  400e14:	e8 07 fe ff ff       	callq  400c20 <exit@plt>f
...
00000000004010f4 <phase_6>:
  ...
  4011ba:	48 89 d9             	mov    %rbx,%rcx ; the addr of current
  ...
  4011e9:	e8 4c 02 00 00       	callq  40143a <explode_bomb> ; next node > current node to trigger the bomb
