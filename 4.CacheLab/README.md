 ...
 *                                       /----------  -----------\
 *              / +-----------+----------+-----------------------+
 *             |  + Valid Bit + Tag Bit  +  0  |  1  |  2  |  3  | 
 *             |  +-----------+----------+-----------------------+ 
 *             |  + Valid Bit + Tag Bit  +  4  |  5  |  6  |  7  |
 *             |   +-----------+----------+----------------------+
 *             |  + Valid Bit + Tag Bit  +  8  |  9  |  10 |  11 |
 *             |  +-----------+----------+-----------------------+
 * 2^5 = 32   /   |   ...        26 lines omitted here    ...    | 
 *   sets     \   +-----------+----------+-----------------------+
 *             |  + Valid Bit + Tag Bit  +  116|  117|  118|  119| 
 *             |  +-----------+----------+-----------------------+
 *             |  + Valid Bit + Tag Bit  +  120|  121|  122|  123|
 *             |  +-----------+----------+-----------------------+
 *             |  + Valid Bit + Tag Bit  +  124|  125|  126|  127|
 *              \ +-----------+----------+-----------------------+
 *                 \--------------------  -----------------------/
 *                                      \/
 *                             1 cache line per set
