...
&emsp;<a href="#1">1. Problem Description</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#2">The tsh speciﬁcation</a>  
&emsp;<a href="#3">2. Background</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#4">2.1 Exceptional Control Flow</a>  
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="#5">2.1.1Exceptions : Hardware and operating system kernel software</a>  
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="#6">2.1.2Exception Handler</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#7">2.2 Difference between **Exception** and **Procedure Call**:</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#8">2.3 Interrupt(Asynchronous Exceptions)</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#9">2.4 Synchronously Exceptions(Faulting Instruction)</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#10">2.5 Traps and System Calls</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#11">2.6 Faluts</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#12">2.7 Aborts</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#13">2.8 Process</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#14">2.9 User and Kernel Mode</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#15">2.10 Context Switch : Hardware timer and kernel software</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#16">2.11 Process Control</a>  
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="#17">2.11.1  `exit()`</a>  
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="#18">2.11.2 `fork()`: </a>  
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="#19">2.11.3 `wait()`</a>  
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="#20">2.11.4 `execve()`</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#21">2.12 Shell</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#22">2.13 Signal : kernel software and application software</a>  
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="#23">2.13.1 Sending Signal</a>  
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="#24">2.13.2 Process Group</a>  
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="#25">2.13.3 Receiving a Signal</a>  
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="#26">2.13.4 Pending and Blocked Signal</a>  
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="#27">2.13.5 Guidelines for Writing Safe Handlers</a>  
&emsp;<a href="#28">3. Solution</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#29">3.1 Check the built-in function</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#30">3.2 SIGINT handler:</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#31">3.3 SIGTSTP handler: </a>  
&emsp;&emsp;&emsp;&emsp;<a href="#32">3.4 SIGCHLD handler</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#33">3.5 Waitfg</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#34">3.6 do_fgbg</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#35">3.7 Eval:</a>  
&emsp;<a href="#36">4. Test Our Shell</a>  
